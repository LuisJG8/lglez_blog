...
This document contains project notes for working on this personal blog.

## CRITICAL GUIDELINES

### NEVER CREATE BLOG POSTS WITHOUT CONSENT

- **NEVER CREATE BLOG POSTS WITHOUT EXPLICIT CONSENT** from the site owner
...
5. **Fixing broken images**:
   ...
   - Blog post images should live in `/public/assets/img/`
   - Reference them from posts with `/assets/img/...`
   - Keep image filenames descriptive and commit the assets with the post
